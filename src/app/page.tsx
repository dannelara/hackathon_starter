...
export default function Home() {
  return (
    <main className="min-h-screen p-24 space-y-8">
      <h1 className="text-5xl">Starter kit</h1>
      <h2 className="text-xl">Ni ska i teams av 2 komma på en idé på något roligt ni vill utveckla!</h2>
      <p>Jag har förberett en startmall för er, som inkluderar tre olika exempelidéer. Ni har tillgång till all kod för att använda som grund. Valet är ert: ni kan antingen implementera något eget och unikt, eller bygga vidare på de exempel som redan finns med.</p>
